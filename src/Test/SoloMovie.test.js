...
import SoloMovie from '../Modules/components/SoloMovieComponent/SoloMovie';
...
describe('SoloMovie', () => {
  it('should render correctly in "debug" mode', () => {
    const component = shallow(<SoloMovie debug/>);
...
it('should render correctly with no props', () => {
    const component = shallow(<SoloMovie/>);
    
    expect(component).toMatchSnapshot();
});

it('should render correctly with given props', () => {
    const component = shallow(<SoloMovie movie={movie}/>);
